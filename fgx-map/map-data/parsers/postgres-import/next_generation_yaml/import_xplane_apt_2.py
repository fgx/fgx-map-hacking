...
import sys, time, datetime, csv, os, re, warnings
import fileinput
...
## Parse Options
##======================================================================
usage = "usage: %prog -d db_connection.yaml /path/to/apt.dat "
#usage += " commands: \n"
...
def readxplane(inputfile):
	...
	cn = 0
	for line in reader: #fileinput.input(inputfile)
		cn += 1
		if cn % 1000 == 0:
			print "line= %s" % cn 
		#print c
